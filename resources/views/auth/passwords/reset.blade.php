...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12 col-md-6 form-container">
            <div class="col-lg-4 col-md-12 col-sm-9 col-xs-12 form-box">
                <div class="reset-form d-block">
                    <div class="reset-form d-block">

                        <h1 class="mb-3 text-center">Recuperar contraseña</h1>
                        ...
                        <form method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="form-input">
                                ...
                                <input id="email" type="email" placeholder="Correo electronico" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus readonly>
